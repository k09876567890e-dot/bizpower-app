...
export const QUESTIONS: Question[] = [
  ...
  {
    id: 3,
    text: "仕事で使う「武器」として、一つ選ぶなら？",
    options: [
      { label: "どんな課題も論破できる「知性の盾」", value: 0, scores: [3, -1, 1, -1, -2] },
      { label: "新しい価値を生む「ひらめきの杖」", value: 0, scores: [0, 3, 0, 2, 1] },
      { label: "皆のやる気を引き出す「共感の聖杯」", value: 0, scores: [0, 0, 3, 0, -1] },
    ]
  },
  {
    id: 4,
...
export const CONCEPT_TEXT = `【理念：個性の覚醒】
BizPowerは、組織という歯車の中で「自分」を見失いかけているあなたのステータスを映し出す鏡です。
自分の「特性」に合わない「戦場」で、間違った「武器」を持たされている人を救うことが唯一の願いです。
`;
...
3. 第三者への提供および広告配信
当サイトでは、第三者配信広告サービス（Googleアドセンス、Amazonアソシエイト、バ慮ーコマース、A8.net、アクセストレード等）を利用しています。これらの事業者は、ユーザーの興味に応じた広告を表示するため、Cookieを使用することがあります。
...
第5条（免責）
・本サービスに起起して利用者に生じた損害について、運営者は一切の賠償責任を負いません。
・アフィリエイトリンク先の商品、サービスに関する契約は利用者と提供者との間で行われるものであり、運営者は関与いたしません。

第6条（準拠法・管轄）
本規約の準拠法は日本法とし、本サービスに関する紛専は運営者の所在地を管轄する裁判所を第一審の専属的合意管轄裁判所とします。
`;
